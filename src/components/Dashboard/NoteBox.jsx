...
const NoteBox = ({ note, onClick, isSelected }) => {
    ...
    const noteDate = note.createdAt // gelen tarihi tr tarihine çevirme
        ? new Date(
    ...
    return (
        ...
        <div onClick={onClick} className='relative bg-notGrey3 w-full h-44 rounded-md hover:bg-notGrey4'>
